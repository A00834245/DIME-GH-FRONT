...
@Component({
  ...
  template: `
    <!-- Show homepage content when not on /map route -->
    <div *ngIf="!isMapRoute" class="homepage">
      <main class="main">
        <div class="content">
          <div class="left-side">
            <svg
            ...
            <h1>Hello, DIME-WEB-APP</h1>
            <p>Congratulations! Your app is running. 🎉</p>
          </div>
          <div class="divider" role="separator" aria-label="Divider"></div>
          <div class="right-side">
            <div class="pill-group">
              <a class="pill" routerLink="/map">
                <span>Go to Map</span>
  ...
  styles: [`
    ...
    .divider {
      width: 1px;
      background: linear-gradient(180deg, var(--orange-red) 0%, var(--vivid-pink) 50%, var(--electric-violet) 100%);
